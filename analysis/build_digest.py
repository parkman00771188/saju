...
EXCLUDE = re.compile(r"제가|저는|저희|우리 |내가 |감사합니다|여사님|선생님|님이|님은|님 |씨가|씨는|씨의|걱정이 많습니다|준비 중인데|연예인|아이돌|BTS|방탄|아이브|세븐틴|장원영|미연|사연|댓글|질문|궁금합니다|인가요|주세요|드릴게요|볼게요|해볼까|들어보|보내 주|시청|채널|영상|구독|\?")
